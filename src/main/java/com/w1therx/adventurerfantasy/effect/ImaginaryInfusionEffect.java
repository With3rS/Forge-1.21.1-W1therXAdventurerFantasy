...
public class ImaginaryInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public ImaginaryInfusionEffect(MobEffectCategory pCategory, int pColor) {
