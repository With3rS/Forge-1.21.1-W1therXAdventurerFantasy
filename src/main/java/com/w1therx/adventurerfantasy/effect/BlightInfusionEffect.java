...
public class BlightInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public BlightInfusionEffect(MobEffectCategory pCategory, int pColor) {
