...
public class WaterInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public WaterInfusionEffect(MobEffectCategory pCategory, int pColor) {
