...
public class EarthInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public EarthInfusionEffect(MobEffectCategory pCategory, int pColor) {
