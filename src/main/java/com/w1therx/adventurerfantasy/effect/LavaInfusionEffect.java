...
public class LavaInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public LavaInfusionEffect(MobEffectCategory pCategory, int pColor) {
