...
public class FireInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public FireInfusionEffect(MobEffectCategory pCategory, int pColor) {
