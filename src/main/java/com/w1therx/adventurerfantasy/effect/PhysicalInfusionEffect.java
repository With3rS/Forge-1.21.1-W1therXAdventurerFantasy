...
public class PhysicalInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public PhysicalInfusionEffect(MobEffectCategory pCategory, int pColor) {
