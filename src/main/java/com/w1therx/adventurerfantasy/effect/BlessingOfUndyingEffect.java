...
public class BlessingOfUndyingEffect extends MobEffect implements ICustomStatusEffect {
    public BlessingOfUndyingEffect(MobEffectCategory pCategory, int pColor) {
