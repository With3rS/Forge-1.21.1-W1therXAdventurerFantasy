...
public class EchoInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public EchoInfusionEffect(MobEffectCategory pCategory, int pColor) {
