...
public class TrueInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public TrueInfusionEffect(MobEffectCategory pCategory, int pColor) {
