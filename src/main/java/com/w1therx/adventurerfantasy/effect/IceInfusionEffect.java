...
public class IceInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public IceInfusionEffect(MobEffectCategory pCategory, int pColor) {
