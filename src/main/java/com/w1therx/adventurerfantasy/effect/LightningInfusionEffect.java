...
public class LightningInfusionEffect extends MobEffect implements ICustomStatusEffect {
    public LightningInfusionEffect(MobEffectCategory pCategory, int pColor) {
